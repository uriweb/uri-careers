		...
		array(
			...
			'fields' => array(
				...
				array(
					...
					'label' => 'DGC Major Page',
					'name' => 'dgc_major_page',
					'aria-label' => '',
					'type' => 'url',
					'instructions' => 'Link to major page',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array(
						'width' => '',
				...
				array(
					'key' => 'field_64dcf684fd994',
					'label' => 'Department People Page',
					'name' => 'department_people_page',
					'aria-label' => '',
					'type' => 'url',
					'instructions' => 'Link to department People Page',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array(
						'width' => '',
				...
				array(
					'key' => 'field_64dcf883fd995',
					'label' => 'UCAS Academic Advisor',
					'name' => 'ucas_academic_advisor',
					'aria-label' => '',
					'type' => 'url',
					'instructions' => 'Link to UCAS Academic Advisor',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array(
						'width' => '',
				...
				array(
					'key' => 'field_64dcf945fd996',
					'label' => 'CES',
					'name' => 'ces',
					'aria-label' => '',
					'type' => 'url',
					'instructions' => 'Link to CES People Page',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array(
						'width' => '',
